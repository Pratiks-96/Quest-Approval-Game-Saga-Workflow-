...
app.post("/workflow/leave", async (req, res) => {
...
app.post("/workflow/leave/:id/approve", async (req, res) => {
  ...
  await axios.put(`${LEAVE}/leaves/${req.params.id}/status`, {
    status: "APPROVED"
  });
  await axios.post(`${NOTIFY}/notify`, {
    message: `Quest ${req.params.id} approved`
  });
...
app.listen(8080, () => console.log("Workflow Service running on 8080"));
